...
CONFIG_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, "confs"))
...
# confile = os.path.join(paths.CONFS_PATH, "yolov3.cfg")
# weightfile = os.path.join(paths.CONFS_PATH, "yolov3.weights")
